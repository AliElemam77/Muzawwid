...
const MESSAGES: Record<Lang, Dict> = {
  ar: {
    ...
    'lp.badge': '⚡ معالجة فورية ومحلية 100%',
    'lp.hero.title1': 'تحويل وتجهيز',
    'lp.hero.title2': 'كتالوج المتجر.',
    'lp.pill.local': 'محلي 100% داخل جهازك',
    'lp.pill.smart': 'مطابقة ذكية للأعمدة',
    'lp.pill.instant': 'تصدير فوري بدون أخطاء',
    'lp.proof.count': '+10,000 منتج معالج',
    'lp.proof.sub': 'بدون خوادم خارجية · حماية كاملة لبياناتك',
    'lp.contact.link': 'تواصل مباشر للمساعدة والدعم ←',
    'lp.platform.label': 'منصة التصدير:',
    'lp.uploader.formats': 'الصيغ: .xlsx, .xls, .csv',
    'lp.uploader.privacy': 'خصوصية تامة 100%',
    'lp.bento.speedTag': 'السرعة والخصوصية',
    'lp.bento.speedTitle1': 'دقة فائقة.',
    'lp.bento.speedTitle2': 'بدون تعقيد.',
    'lp.bento.speedBody': 'وداعاً لتضييع الساعات في تعديل أعمدة الإكسيل يدوياً. مزوّد يحلل الشيت ويدمج الخيارات والأسعار فوراً دون إرسال أي بايت لخادم خارجي.',
    'lp.bento.statTime': 'متوسط زمن التصدير',
    'lp.bento.statPrivacy': 'حفظ لسرية المخازن',
    'lp.bento.structTag': 'تصدير مهيكل',
    'lp.bento.structTitle': 'مخرجات مطابقة لاشتراطات المتاجر',
    'lp.bento.structBody': 'سلسلة متصلة من صف المنتج الأصلي يليه كافة تفرعات المقاس واللون مع السعر والوزن.',
    'lp.bento.mockReady': 'جاهز 100%!',
    'lp.feat.sectionEyebrow': 'المزايا والمنظومة',
    'lp.feat.sectionTitle': 'أدوات متكاملة لإدارة كتالوج متجرك',
    'lp.feat.autoTag': 'أتمتة ذكية',
    'lp.feat.scraperCard': 'سحب الصور بالذكاء الاصطناعي',
    'lp.feat.scraperTitle': 'استخراج الصور من الروابط',
    'lp.feat.scraperBody': 'سحب وتحليل صور المنتجات تلقائياً من روابط الموردين (Shopify, WooCommerce, WordPress)',
    'lp.feat.ecoTag': 'منظومة المطورين',
    'lp.feat.wepixCard': 'ستوديو Wepix',
    'lp.feat.wepixTitle': 'ضغط وتحسين الصور Wepix',
    'lp.feat.wepixBody': 'تسريع متجرك وتحسين السيو بضغط صور المنتجات وتحويلها إلى صيغة WebP',
    'lp.mock.optProduct': 'منتج',
    'lp.mock.optVariant': 'خيار',
    'sku.noneHint': 'لن يتم توليد أو تصدير رمز SKU للمنتجات (سيُترك العمود فارغًا).',
    'sku.sampleTitle': 'معاينة الرمز المولد:',
    'sku.sampleProduct': 'منتج:',
    'sku.sampleOption': 'خيار:',
    'images.selectedCount': 'تم تحديد {n} أعمدة',
    'nav.converter': 'المحول السريع',
    'nav.quickTest': 'فحص الروابط',
    'nav.history': 'ملفاتك المحفوظة',
    ...
    'tpl.starterApply': 'اضغط عشان تطبّق القالب ده — هيستبدل المحتوى الحالي',
    ...
    'scrape.switchLabel': 'تفعيل الجلب التلقائي للصور',
    'scrape.switchDesc': 'فحص روابط المنتجات واستخراج كل الصور الناقصة تلقائياً',
    'scrape.enabled': 'مفعل',
    'scrape.disabled': 'معطل',
    'scrape.quickTest': 'تجربة رابط سريع',
    'scrape.quickTestDesc': 'اختبر أي رابط منتج للتأكد من الصور قبل بدء الفحص للشيت بالكامل',
    'scrape.quickTestBtn': 'فحص الرابط 🚀',
    'scrape.testerTitle': 'مجرّب روابط المنتجات السريع',
    ...
    'val.priceNotNumber':
      'منتجات سعرها ليس رقمًا — سعر المنتج لازم يكون رقم (مثل 99 أو 99.50)',
  ...
  en: {
    ...
    'lp.badge': '⚡ 100% LOCAL & INSTANT PROCESSING',
    'lp.hero.title1': 'CATALOG',
    'lp.hero.title2': 'TRANSFORM.',
    'lp.pill.local': '100% In-Browser Local',
    'lp.pill.smart': 'Smart Column Mapping',
    'lp.pill.instant': 'Instant Store Export',
    'lp.proof.count': '10,000+ Products Processed',
    'lp.proof.sub': 'Zero External Servers · 100% Private',
    'lp.contact.link': 'Direct Support & Feedback →',
    'lp.platform.label': 'Target Platform:',
    'lp.uploader.formats': 'Formats: .xlsx, .xls, .csv',
    'lp.uploader.privacy': '100% In-Browser Privacy',
    'lp.bento.speedTag': 'SPEED & PRIVACY',
    'lp.bento.speedTitle1': 'HIGHER CTR.',
    'lp.bento.speedTitle2': 'ZERO FRICTION.',
    'lp.bento.speedBody': 'Stop wasting hours reformatting spreadsheets manually. Muzawwid analyzes your sheet, auto-maps columns, and formats variants in seconds without uploading data.',
    'lp.bento.statTime': 'Average Export Time',
    'lp.bento.statPrivacy': 'Data Privacy Guaranteed',
    'lp.bento.structTag': 'STRUCTURED EXPORT',
    'lp.bento.structTitle': 'Ready For Store Import',
    'lp.bento.structBody': 'Structured parent product rows followed by option variants, weights, and SKUs.',
    'lp.bento.mockReady': '100% READY!',
    'lp.feat.sectionEyebrow': 'FEATURES & ECOSYSTEM',
    'lp.feat.sectionTitle': 'Complete Toolkit For Your Store Catalog',
    'lp.feat.autoTag': 'SMART AUTOMATION',
    'lp.feat.scraperCard': 'AI Product Image Scraper',
    'lp.feat.scraperTitle': 'Extract Images From URLs',
    'lp.feat.scraperBody': 'Extract product gallery images automatically from supplier links (Shopify, WooCommerce, WordPress)',
    'lp.feat.ecoTag': 'DEVELOPER ECOSYSTEM',
    'lp.feat.wepixCard': 'Wepix Studio',
    'lp.feat.wepixTitle': 'Wepix Image Compression & WebP',
    'lp.feat.wepixBody': 'Compress and convert product images to WebP to boost store speed and SEO',
    'lp.mock.optProduct': 'Product',
    'lp.mock.optVariant': 'Option',
    'sku.noneHint': 'No SKU will be generated or exported (the column will remain empty).',
    'sku.sampleTitle': 'Generated SKU preview:',
    'sku.sampleProduct': 'Product:',
    'sku.sampleOption': 'Option:',
    'images.selectedCount': '{n} column(s) selected',
    'nav.converter': 'Smart Converter',
    'nav.quickTest': 'URL Tester',
    'nav.history': 'Saved Sheets',
    ...
    'tpl.starterApply': 'Click to apply this template — it replaces the current content',
    ...
    'scrape.switchLabel': 'Enable Automatic Image Extraction',
    'scrape.switchDesc': 'Inspect product URLs and pull missing gallery images automatically',
    'scrape.enabled': 'Enabled',
    'scrape.disabled': 'Disabled',
    'scrape.quickTest': 'Quick URL Tester',
    'scrape.quickTestDesc': 'Test any product link to verify images before running on the full sheet',
    'scrape.quickTestBtn': 'Test URL 🚀',
    'scrape.testerTitle': 'Quick Product URL Tester',
    ...
    'val.priceNotNumber':
      'Products whose price is not a number — the price must be numeric (e.g. 99 or 99.50)',
